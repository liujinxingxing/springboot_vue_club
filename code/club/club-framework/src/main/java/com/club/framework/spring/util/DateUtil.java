...
public class DateUtil extends DateUtils {
	 ...
	 * 获取上月的开始时间
	 */
	public static Date getBeginDayOfyesMonth() {
		Calendar calendar = Calendar.getInstance();
	 ...
	 * 获取上月的结束时间
	 */
	public static Date getEndDayOfyesMonth() {
		Calendar calendar=Calendar.getInstance();
	 ...
	 * @return
	 */
	public static Date setNowHms(Date date) {
	 ...
	 * @return
	 */
	public static Date setMaxHsm(Date date) {
		if (date == null) {
			return null;
		}
		Calendar calendar = Calendar.getInstance();
	 ...
	 * @return
	 */
	public static Date setMinHsm(Date date){
		if (date == null) {
			return null;
		}
		Calendar calendar = Calendar.getInstance();
