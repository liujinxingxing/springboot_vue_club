package com.club.framework.mybatis.mybatis.interceptor;
...
public class CameHumpInterceptor implements Interceptor {
    ...
    protected static final String HUMP = "_[a-z]";
     ...
     * 将下划线风格替换为驼峰风格
     * @param str - 字段名称
     * @return java.lang.String - 转换后的名称
     * @author 阳春白雪 | sample@gmail.com
     * @date 2022年2月20日
     * @since 1.0
     */
    public static String underlineToCamelhump(String str) {
        Matcher matcher = Pattern.compile(HUMP).matcher(str);
